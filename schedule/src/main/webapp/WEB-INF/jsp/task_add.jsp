	        ...
	        <tr>
	            ...
	            <td>
	            	<input class="easyui-combobox" name="workId"  panelHeight="auto" 
    					data-options="valueField:'workId',textField:'workId',url:'http://localhost:10010/schedule/work/get_data',
	        ...
	        <tr>
	            ...
	            <td>
	            	<input class="easyui-combobox" name="manufactureSn"  panelHeight="auto" 
    					data-options="valueField:'manufactureSn',textField:'manufactureSn',url:'http://localhost:10010/schedule/manufacture/get_data',
    						editable:false, required:true" />
    			</td>  
	        </tr>
	        <tr>
...
<script type="text/javascript">
	...
	function submitTaskAddForm(){
		...
		$.post("http://localhost:10010/schedule/task/insert",$("#taskAddForm").serialize(), function(data){
			if(data.status == 200){
