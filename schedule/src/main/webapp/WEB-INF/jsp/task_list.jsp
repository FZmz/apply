...
<table class="easyui-datagrid" id="taskList" title="生产派工列表" data-options="singleSelect:false,collapsible:true,
		pagination:true,rownumbers:true,url:'http://localhost:10010/schedule/task/list',method:'get',pageSize:10,fitColumns:true,toolbar:toolbar_task">
    <thead>
        <tr>
...
<div id="taskEditWindow" class="easyui-window" title="编辑生产派工" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'http://localhost:10010/schedule/task/edit'" style="width:40%;height:55%;padding:10px;">
</div>
<div id="taskAddWindow" class="easyui-window" title="添加生产派工" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'http://localhost:10010/schedule/task/add'" style="width:40%;height:55%;padding:10px;">
</div>
	        ...
	        <tr>
	            ...
	            <td>
	            	<input class="easyui-combobox" name="productId" data-options="valueField:'productId',
	            		textField:'productName',url:'http://localhost:10010/schedule/product/get_data', editable:false"/>
    			</td>  
	        </tr>
	        <tr>
	            <td>工序:</td>
	            <td>
	            	<input class="easyui-combobox" name="processId" data-options="valueField:'processId',
	            		textField:'processId',url:'http://localhost:10010/schedule/process/get_data', editable:false"/>
    			</td>  
	        </tr>
	        <tr>
	            <td>设备:</td>
	            <td>
	            	<input class="easyui-combobox" name="deviceId" data-options="valueField:'deviceId',
	            		textField:'deviceName',url:'http://localhost:10010/schedule/deviceList/get_data', editable:false"/>
    			</td>  
	        </tr>
	        <tr>
	            <td>班产定额:</td>
	        ...
	        <tr>
	            ...
	            <td>
	            	<input class="easyui-combobox" name="orderId" data-options="required:true,valueField:'orderId',
	            		textField:'orderId',url:'http://localhost:10010/schedule/order/get_data', editable:false" />
	            </td>
	        </tr>
	        <tr>
	            <td>工艺:</td>
	            <td>
	            	<input class="easyui-combobox" name="technologyId" data-options="valueField:'technologyId',
	            		textField:'technologyName',url:'http://localhost:10010/schedule/product/get_data', editable:false"/>
    			</td>  
	        </tr>
	        <tr>
	            <td>投产数量:</td>
...
function doSearch_task(value,name){ //用户输入用户名,点击搜素,触发此函数  
	if(value == null || value == ''){
		...
		$("#taskList").datagrid({
			...
			nowrap:true, toolbar:"toolbar_task", url:'http://localhost:10010/schedule/task/list', method:'get', loadMsg:'数据加载中......',
		...
		$("#taskList").datagrid({  
	        title:'生产派工列表', singleSelect:false, collapsible:true, pagination:true, rownumbers:true, method:'get',
			nowrap:true, toolbar:"toolbar_task", url:'http://localhost:10010/schedule/task/search_task_by_'+name+'?searchValue='+value,
...
//格式化作业信息
	...
	function  openTaskWork(index){ 
		...
		$("#taskWorkInfo").dialog({
    		onOpen :function(){
    			$.get("http://localhost:10010/schedule/work/get/"+row.workId,'',function(data){
	...
	function submitTaskWorkEditForm(){
		$.get("/work/edit_judge",'',function(data){
    		if(data.msg != null){
    			...
    			$.post("http://localhost:10010/schedule/work/update_all",$("#taskWorkEditForm").serialize(), function(data){
    				if(data.status == 200){
	...
	function  openTaskManufacture(index){ 
		...
		$("#taskManufactureInfo").dialog({
    		onOpen :function(){
    			$.get("http://localhost:10010/schedule/manufacture/get/"+row.manufactureSn,'',function(data){
	...
	function submitTaskManufactureEditForm(){
		$.get("/manufacture/edit_judge",'',function(data){
    		if(data.msg != null){
    			...
    			$.post("http://localhost:10010/schedule/manufacture/update_all",$("#taskManufactureEditForm").serialize(), function(data){
    				if(data.status == 200){
    	...
    	$.get("/task/delete_judge",'',function(data){
      		if(data.msg != null){
            	...
            	$.messager.confirm('确认','确定删除ID为 '+ids+' 的生产派工吗？',function(r){
            	    if (r){
            	    	var params = {"ids":ids};
                    	$.post("http://localhost:10010/schedule/task/delete_batch",params, function(data){
                			if(data.status == 200){
