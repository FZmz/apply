	        ...
	        <tr>
	            ...
	            <td>
	            	<input class="easyui-combobox" name="manufactureSn"   panelHeight="auto"
    						...
    						url:'http://localhost:10010/schedule/manufacture/get_data', editable:false, required:true" />
    			</td>  
	        </tr>
	        <tr>
	            <td>派工数量:</td>
...
<script type="text/javascript">
	function submitTaskEditForm(){
		...
		$.post("http://localhost:10010/schedule/task/update_all",$("#taskEditForm").serialize(), function(data){
			if(data.status == 200){
