	        ...
	        <tr>
	            ...
	            <td>
	            	<input id="custom" class="easyui-combobox" name="customId"  panelHeight="auto"
    					data-options="required:true,valueField:'customId',textField:'customName',url:'http://localhost:10010/schedule/custom/get_data',
    					editable:false" />
	            </td>
	        </tr>
	        <tr>
...
<script type="text/javascript">
	...
	function submitOrderAddForm(){
		...
		$.post("http://localhost:10010/schedule/order/insert",$("#orderAddForm").serialize(), function(data){
			if(data.status == 200){
