	         ...
	         <tr>
	            ...
	            <td>
	            	<input id="custom" class="easyui-combobox" name="customId"  panelHeight="auto"
						   ...
						   url:'http://localhost:10010/schedule/custom/get_data', editable:false" />
	            </td>
	        </tr>
	        <tr>
	            <td>订购产品:</td>
...
<script type="text/javascript">
	...
	function submitOrderEditForm(){
		...
		$.post("http://localhost:10010/schedule/order/update_all",$("#orderEditForm").serialize(), function(data){
			if(data.status == 200){
