	        ...
	        <tr>
	            ...
	            <td>
	            	<input class="easyui-combobox" name="orderId"  panelHeight="auto" data-options="required:true,
	            		valueField:'orderId',textField:'orderId',url:'http://localhost:10010/schedule/order/get_data', editable:false" />
	            </td>
	        </tr>
	        <tr>
	            <td>工艺:</td>
	            <td>
	            	<input class="easyui-combobox" name="technologyId"  panelHeight="auto"
						   data-options="valueField:'technologyId',textField:'technologyName',url:'http://localhost:10010/schedule/technology/get_data',
...
<script type="text/javascript">
	function submitManufactureEditForm(){
		...
		$.post("http://localhost:10010/schedule/manufacture/update_all",$("#manufactureEditForm").serialize(), function(data){
			if(data.status == 200){
